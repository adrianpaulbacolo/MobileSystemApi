        ...
        if (!Page.IsPostBack)
        {
            ...
            using (RewardsServices.RewardsServicesClient sClient = new RewardsServices.RewardsServicesClient())
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    System.Web.HttpContext.Current.Session["pointsBalance"] = (int)System.Web.HttpContext.Current.Session["pointsBalance"] - (int)System.Web.HttpContext.Current.Session["pointsCart"];
