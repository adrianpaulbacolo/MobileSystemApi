...
public partial class Catalogue_Redeem : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            //   string strProcessRemark = string.Format("MemberCode: {0} | Password: {1} | VCode: {2} | SVCode: {3} | IP: {4} | Country: {5}", strMemberCode, strPassword, strVCode, strSessionVCode, strLoginIp, strCountryCode);

            System.Xml.XmlNode xnRootNode = xdResponse.CreateElement("Redeem");
            ...
            xnCodeNode.InnerText = "1";
            xnMessageNode.InnerText = "submission successful";
