...
public partial class _Index : BasePage
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            commonAuditTrail.appendLog("system", "Catalogue/Default.aspx", "Page_Init", "Default.aspx", "", "Page_Init", "", ex.Message + " stacktrace: " + ex.StackTrace, "" + "" + "" + "", "", newerrorid.ToString(), false);
        }
