<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DefaultO.aspx.cs" Inherits="_Default" %>
...
<%--    <link href="../_Static/Css/Main.css" rel="stylesheet" />--%>
    <link href="../_Static/Css/CatalogueOld.css" rel="stylesheet" />

    <script src="../_Static/JS/iscroll.js"></script>
    ...
    <script type="text/javascript">
        ...
        function ProductScroll() {
            VerScroll = new IScroll('#resultwrapper', { bounceEasing: 'elastic', bounceTime: 1200 });
        }
                ...
                <div id="categorywrapper" style="overflow: hidden;">
                    <div id="category-nav">
                        <ul id="categorylist" class="">
                            <li><a data-role="button"  href="#" class="current-cat" data-filter="all">
                                <span class="image">
                                    <img height="60" alt="" src="../_Static/Images/c_all.png"></span>
                                <span class="label">All</span>
                            </a></li>
                            <li><a data-role="button"  href="#" data-filter="football">
                                <span class="image">
