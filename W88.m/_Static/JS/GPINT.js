...
$(function () {
    $(window).bind("load resize", function () {
        var bgimg_width = ($('.div-nav-header').width() - 51 - $('.div-nav-header > div:last-child').width()) / 2;
        if (bgimg_width > 50) { $('.div-nav-header').css({ backgroundPosition: bgimg_width + 'px center' }) }
    });

    $("a").click(function () { if ($(this).attr('data-load-ignore-splash') != 'true' && $(this).attr('data-rel') != "dialog") { if ($(this).className != null) { if ($(this).className.indexOf('ui-collapsible-heading-toggle') < 0) { GPINTMOBILE.ShowSplash(); } } } });
});
