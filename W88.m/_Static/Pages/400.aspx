...
<meta>
    ...
    <title><%=commonCulture.ElementValues.getResourceXPathString("HttpError/e400title", commonVariables.ErrorsXML)%></title>
...
<body>
    ...
    <section class="container main">
        ...
        <h1><%=commonCulture.ElementValues.getResourceXPathString("StatusCode/e400", commonVariables.ErrorsXML)%></h1>
        <h3><%=commonCulture.ElementValues.getResourceXPathString("HttpError/e400title", commonVariables.ErrorsXML)%></h3>
        <p><%=commonCulture.ElementValues.getResourceXPathString("HttpError/e400", commonVariables.ErrorsXML)%></p>
    </section>
