...
<meta>
    ...
    <title><%=commonCulture.ElementValues.getResourceXPathString("HttpError/e408title", commonVariables.ErrorsXML)%></title>
    ...
    <section>
        <div class="error-container">
            <div class="error-content">
                <h1><%=commonCulture.ElementValues.getResourceXPathString("StatusCode/e408", commonVariables.ErrorsXML)%></h1>
                <h3><%=commonCulture.ElementValues.getResourceXPathString("HttpError/e408title", commonVariables.ErrorsXML)%></h3>
                <p><%=commonCulture.ElementValues.getResourceXPathString("HttpError/e408", commonVariables.ErrorsXML)%></p>
                <ul>
                    <li>
                        <a href="/Index.aspx">
