...
<asp:Content ID="InnerScriptBottom" ContentPlaceHolderID="InnerScriptPlaceHolder" runat="server">
    ...
    <script src="<%=ConfigurationManager.AppSettings.Get("AssetsPath") %>/assets/js/modules/accounts/changepassword.js?v=<%=ConfigurationManager.AppSettings.Get("scriptVersion") %>"></script>
