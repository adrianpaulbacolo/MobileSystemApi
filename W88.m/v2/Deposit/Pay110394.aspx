...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptsHolder" runat="Server">
    <script type="text/javascript" src="/_static/v2/assets/js/gateways/paygo.js?v=<%=ConfigurationManager.AppSettings.Get("scriptVersion") %>"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            window.w88Mobile.Gateways.PayGoV2.init();
