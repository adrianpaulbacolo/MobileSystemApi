    ...
    <div id="divMain" data-role="page" data-theme="b" data-ajax="false">
        ...
        <div class="ui-content" role="main">
            ...
            <section class="section banner-slider">
                <div class="slide">
                    <a rel="texasmahjong" href="https://tm.gp2play.com/TexasMahjong-captive-runtime_w88_1.0.apk" data-ajax="false">
        ...
        <% } %>
            ...
            <ul class="row row-bordered bg-gradient">
                ...
                <li class="col col-33 product">
                    <a href="https://tm.gp2play.com/TexasMahjong-captive-runtime_w88_1.0.apk" class="tile nav-texasmahjong" target="_blank">
