<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BankTransfer_app.aspx.cs" Inherits="BankTransfer_app" %>
                ...
                <form id="form1" runat="server" data-ajax="false">
                    ...
                    <div>
                         <table style="width:100%">
                            <tr>
                                <td style="width:50%">
                                    <input type="button" onclick="location.href = '/Deposit/Default_app.aspx';" value="Deposit" class="button-blue"  data-corners="false" />
                                </td>
                                <td style="width:50%">
                                     <input type="button" onclick="location.href = '/FundTransfer/FundTransfer.aspx';" value="Fund Transfer" class="button-blue"  data-corners="false" />
                                </td>
                            </tr>
                        </table>
                    </div>
