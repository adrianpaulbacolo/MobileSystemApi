        ...
        <div class="ui-content" role="main">
            ...
            <div class="page-content">
                <div data-role="navbar">
                    <ul>
                        <li id="<%=string.Format("d{0}", Convert.ToInt32(commonVariables.DepositMethod.FastDeposit))%>"><a href="/Deposit/FastDeposit" data-ajax="false" class="ui-btn-active"><%=commonCulture.ElementValues.getResourceString("fastdeposit", commonVariables.LeftMenuXML)%></a></li>
