...
public partial class Deposit_Default : BasePage
{
    ...
    protected void WithrawalNav_btn_Click(object sender, EventArgs e)
    {
        Response.Redirect("/Withdrawal/Withrawal.aspx");
    }
    protected void FundTransferNav_btn_Click(object sender, EventArgs e)
    {
