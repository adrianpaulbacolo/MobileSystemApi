        ...
        try
        {
            if (Request.QueryString["username"] != null && Request.QueryString["token"] != null)
            {
                using (var client = new memberWSSoapClient())
                {
                    ...
                    commonAuditTrail.appendLog(_username, "_Secure_AutoLogin", "Params", string.Empty, string.Empty, string.Empty, "-99", string.Empty, string.Empty, string.Empty, string.Empty, true);
                    ...
                    if (dsData.Tables.Count > 0 && dsData.Tables[0].Rows.Count > 0)
                    {
                        ...
                        commonAuditTrail.appendLog(_username, "_Secure_AutoLogin", "Response", string.Empty, string.Empty, string.Empty, "-99", string.Empty, result.ToString(), string.Empty, string.Empty, true);
