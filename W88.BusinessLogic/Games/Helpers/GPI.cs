...
namespace Helpers.GameProviders
{
    ...
    public sealed class Gpi
    {
        ...
        public Gpi(GameLinkInfo gameLink, string language)
        {
        ...
        {
            return CultureHelpers.ElementValues.GetResourceXPathAttribute("Type", element).Equals("rslot", StringComparison.OrdinalIgnoreCase);
        }
