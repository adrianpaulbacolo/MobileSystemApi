<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommissionPlans.aspx.cs" Inherits="_CommissionPlans" %>
   ...
   <%-- <form id="form1" runat="server">
     ...
     <div id="divMain" data-role="page">
        ...
        <div class="ui-content" role="main">
            ...
            <div class="div-page-header"><span><%=commonCulture.ElementValues.getResourceString("commissionPlans", commonVariables.LeftMenuXML)%></span></div>
